// The original Pie Chart design and enter animation is Credited to Siddharth Parmar at https://codepen.io/Siddharth11/pen/LVQmjN

// I simply made it interactive for the user.
...
const colors = ['#0B00FF', '#0097FF', '#00FFF0', '#00FF74', '#0BFF00', '#FFF900', '#FF5500', '#FF0500', '#FF007F', '#B800FF']

//'#FF004C', #FF00D9

const content = [
  'React', 'Angular', 'Vue', 'Framework', 'Backbone', 'Polymer', 'Ember', 'Meteor', 'Knockout', 'TodoMVC'
]
